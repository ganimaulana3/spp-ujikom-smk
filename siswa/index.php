...
<div class="main-menu menu-fixed menu-light menu-accordion d-print-none menu-shadow " data-scroll-to-active="true"
		...
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" href="">
					<img class="brand-logo"
					 	...
					 	<span style="left:10px;font-size:larger;" class="text-black position-relative"><?php echo $_SESSION['nama'] ?></span></li>
	...
	<div class="main-menu-content">
		<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			<li class="nav-item"><a
					href="../siswa/dashboard.php"><i class="ft-home"></i><span class="menu-title"
																					 data-i18n="">Dashboard</span></a>
			</li>
			
			<li class=" nav-item"><a
					href="../siswa/history_pembayaran.php?id=<?php echo $_SESSION['nisn']; ?>"><i class="ft-calendar"></i><span class="menu-title"
