...
$query = "SELECT * FROM siswa,kelas,spp,petugas where nisn='$nisn' AND siswa.id_kelas=kelas.id_kelas AND siswa.id_spp=spp.id_spp";
$result = mysqli_query($koneksi, $query);
if (!$result) {
  die("Query Error: " . mysqli_errno($koneksi) .
    " - " . mysqli_error($koneksi));
                ...
                <div class="row">
                  ...
                  <div class="col mb-3">
                    <div class="form-outline">
                      ...
                      <input type="text" class="form-control" id="InputTanggalBayar" value="<?php echo $_SESSION['nama_petugas']; ?>" disabled>
