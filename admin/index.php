<?php
	...
	include '../admin/tgl_indo_helper.php';
	session_start();
...
<div class="main-menu menu-fixed menu-light menu-accordion d-print-none menu-shadow " data-scroll-to-active="true"
	...
	<div class="main-menu-content">
		<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			<li class="nav-item"><a
					href="../admin/dashboard.php"><i class="ft-home"></i><span class="menu-title"
			...
			<li class="nav-item"><a href="#"><i class="ft-layers">
				...
				<ul class="menu-content">
					...
					<li class="">
                        <a class="menu-item" href="../admin/data_siswa.php">
                            <i class="ft-users"> </i> 
                            Data Siswa</a>
					</li>
					<li class="">
                        <a class="menu-item" href="../admin/data_petugas.php">
                            <i class="ft-users"> </i> 
                            Data Petugas</a>
					</li>
                    <li class="">
                        <a class="menu-item" href="../admin/data_kelas.php">
                            <i class="bx bx-data"> </i> 
                            Data Kelas</a>
					</li>
                    <li class="">
                        <a class="menu-item" href="../admin/data_spp.php">
                            <i class="bx bx-data"> </i> 
                            Data SPP</a>
					</li>
			...
			<li class=" nav-item"><a
					href="../admin/transaksi_pembayaran.php"><i class="icon-wallet"></i><span class="menu-title"
																					data-i18n="">Transaksi</span></a>
			</li>
			<li class=" nav-item"><a
					href="../admin/history_pembayaran.php"><i class="bx bx-history"></i><span class="menu-title"
																					  data-i18n="">History</span></a>
			</li>
			<li class=" nav-item"><a href="../admin/laporan.php"><i class="ft-file"></i><span
						class="menu-title"
