								...
								<button
									...
									title="Hapus data siswa"><i class="ft-trash"></i></button>-->
													...
													if ($sisa == 0) {
														...
														<a class="badge badge-warning text-white" href="edit_pembayaran.php?id_pembayaran=<?php echo $row['id_pembayaran'] ?>&sisa=<?php echo $sisa ?>" title="Bayar Sekarang!"><i class='ft-x-circle'></i> Belum Lunas</a>
													<?php
													}
													?>
											...
											<div class="col-6">
												<table style="width: 100%">
													<tr>
														<td>Tgl Bayar</td>
														<td>:</td>
														<td> <?php echo date_indo(date($row['tgl_bayar']), "d-m-Y"); ?></td>
													</tr>
													<tr>
														<td>Bulan Bayar</td>
														<td>:</td>
