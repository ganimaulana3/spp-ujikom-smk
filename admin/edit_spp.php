<?php
  ...
  if (isset($_GET['id'])) {
    ...
    echo "<script>alert('Masukkan data id.');window.location='../admin/data_spp.php';</script>";
  }    
?>
<!DOCTYPE html>
<html lang="en">
...
<div style="position:relative;bottom:80vh;" class="app-content content">
	...
	<div class="col-md-12">
		<div class="card box-shadow-2">
			...
			<form class="wizard-content mt-2" method="post" action="controller_edit_spp.php">
                      <div class="wizard-pane">
                        <input name="id" value="<?php echo $data['id_spp']; ?>"  hidden />
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right">TAHUN</label>
                          <div class="col-lg-4 col-md-6">
                            <input class="form-control" type="number" name="tahun" value="<?php echo $data['tahun']; ?>" disabled="disabled"/>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right">NOMINAL</label>
                          <div class="col-lg-4 col-md-6">
                              <input class="form-control" type="number" name="nominal" value="<?php echo $data['nominal']; ?>" required=""/>
                          </div>
                        </div>
                          <center>
